      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 sm:pt-24 sm:pb-12 lg:pt-32 lg:pb-16 flex items-center justify-center min-h-[70vh]">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto px-0 sm:px-4 w-full">
          ...
          <div className="flex items-center gap-3 mb-5 sm:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <SoundwaveBars />
            <span 
              className="font-sans text-xs sm:text-base font-medium tracking-widest uppercase"
              style={{ color: '#CF9D3E' }}
            >
              Spoken Scripture ✝
            </span>
          ...
          <h1 
            className="font-serif text-3xl sm:text-5xl md:text-6xl leading-tight mb-3 sm:mb-6 text-balance font-bold animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100"
            style={{ color: '#001C5F' }}
          >
          ...
          <p 
            className="font-serif italic text-lg sm:text-2xl md:text-3xl mb-5 sm:mb-8 text-balance animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200"
          ...
          <p 
            className="font-sans text-sm sm:text-[16px] max-w-2xl mb-6 sm:mb-10 text-pretty animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 px-2 sm:px-0"
